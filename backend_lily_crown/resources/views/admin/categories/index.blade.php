                    ...
                    @forelse($categories as $category)
                        <tr>
                            ...
                            <td>
                                ...
                                @endphp
                                @if($displayImage)
                                    <img src="{{ Str::startsWith($displayImage, 'http') ? $displayImage : asset($displayImage) }}" alt="{{ $category->name }}" style="width: 50px; height: 50px; object-fit: cover; border-radius: 8px; border: 1px solid #d4af37;">
                                @else
