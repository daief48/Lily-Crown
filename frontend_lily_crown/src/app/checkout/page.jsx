...
import { ShieldCheck, Truck, RefreshCw, ChevronLeft, CreditCard, Plus, Minus, Trash2 } from "lucide-react";
        ...
        <main className="bg-muslin-cream min-h-screen pb-16">
            ...
            <div className="pt-32 max-w-7xl mx-auto px-4 md:px-6">
                <Link href="/cart" className="flex items-center gap-2 text-emerald-royal/60 hover:text-emerald-royal mb-8 transition-colors group">
                    ...
                    <span className="uppercase tracking-widest text-[10px] font-bold">{t('checkout_back_to_cart')}</span>
                </Link>

                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    {/* Shipping Form */}
                    <div className="bg-white p-8 md:p-12 shadow-2xl border border-heritage-gold/10 rounded-sm">
                        <h2 className="text-3xl font-serif text-emerald-royal mb-8">{t('checkout_shipping_title')}</h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] uppercase tracking-widest font-bold text-emerald-royal/50 ml-1">{t('checkout_phone_label')}</label>
                                <input
                                    required
                                    type="tel"
                                    name="phone"
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] uppercase tracking-widest font-bold text-emerald-royal/50 ml-1">{t('orders_delivery_address')}</label>
                                <textarea
                                    required
                                    name="address"
                                    rows="3"
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] uppercase tracking-widest font-bold text-emerald-royal/50 ml-1">{t('checkout_city_label')}</label>
                                <input
                                    required
                                    type="text"
                                    name="city"
                            ...
                            <div className="pt-8 border-t border-heritage-gold/10">
                                ...
                                <div className="p-4 bg-emerald-royal/5 border border-heritage-gold/20 rounded-sm flex items-center justify-between group cursor-pointer">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="text-sm font-bold text-emerald-royal uppercase tracking-wider">{t('checkout_cod')}</p>
                                            <p className="text-[10px] text-emerald-royal/50">{t('checkout_cod_desc')}</p>
                                        </div>
                                    </div>
                                    <span className="text-heritage-gold font-bold text-xs uppercase tracking-widest">{t('checkout_selected')}</span>
                                </div>
                            </div>
                    ...
                    <div className="lg:sticky lg:top-32 space-y-8">
                        <div className="bg-emerald-royal p-8 text-white shadow-2xl border-l-4 border-heritage-gold">
                            <h3 className="text-xl font-serif mb-6 border-b border-white/10 pb-4">{t('checkout_order_summary_title')}</h3>
                                    ...
                                    <div key={item.id} className="flex gap-4 group/item">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="flex items-center justify-between mt-2">
                                                ...
                                                <p className="text-xs font-bold text-heritage-gold">Tk {(item.price * item.quantity).toLocaleString()}</p>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                            ...
                            <div className="mt-8 pt-6 border-t border-white/10 space-y-4">
                                ...
                                <div className="flex justify-between text-white/60 text-xs uppercase tracking-widest">
                                    ...
                                    <span className="text-heritage-gold italic">{t('checkout_shipping_free')}</span>
                                </div>
                                <div className="flex justify-between text-xl font-bold pt-4 border-t border-white/10">
                                    <span className="font-serif">{t('cart_total')}</span>
                                    <span className="text-heritage-gold">Tk {cartTotal.toLocaleString()}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="bg-white p-4 rounded-sm border border-heritage-gold/10 text-center space-y-2">
                                ...
                                <p className="text-[9px] uppercase tracking-widest font-bold text-emerald-royal">{t('checkout_badge_secure')}</p>
                            </div>
                            <div className="bg-white p-4 rounded-sm border border-heritage-gold/10 text-center space-y-2">
                                <Truck size={24} className="mx-auto text-heritage-gold" />
                                <p className="text-[9px] uppercase tracking-widest font-bold text-emerald-royal">{t('checkout_badge_delivery')}</p>
                            </div>
                            <div className="bg-white p-4 rounded-sm border border-heritage-gold/10 text-center space-y-2">
                                <RefreshCw size={24} className="mx-auto text-heritage-gold" />
                                <p className="text-[9px] uppercase tracking-widest font-bold text-emerald-royal">{t('checkout_badge_exchange')}</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div key={item.id} className="flex gap-4 group/item">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex items-center justify-between mt-2">
                                            ...
                                            <p className="text-xs font-bold text-heritage-gold">৳{(item.price * item.quantity).toLocaleString()}</p>
                                        </div>
                                    </div>
                                </div>
                            ))}
