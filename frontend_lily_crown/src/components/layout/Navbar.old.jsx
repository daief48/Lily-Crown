...
export function Navbar() {
    ...
    const LangToggle = ({ className = "" }) => (
        <button
            onClick={toggleLang}
            className={`flex items-center gap-1 border border-emerald-royal/20 rounded-full px-2.5 py-1 text-[9px] uppercase tracking-widest font-bold hover:border-heritage-gold hover:text-heritage-gold transition-all duration-300 ${className}`}
    ...
    return (
        <nav
            className={cn(
                ...
                isScrolled
                    ? "bg-white/95 backdrop-blur-md shadow-xl py-3 border-b border-heritage-gold/10"
        ...
        >
            <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
                <div className="flex items-center justify-between gap-4">
                            ...
                            >
                                {link.hasDropdown ? (
                                    <button
                                        ...
                                        className="flex items-center gap-2 text-xs uppercase tracking-[0.1em] font-medium text-emerald-royal hover:text-heritage-gold transition-all whitespace-nowrap py-2"
                                    >
                                        {link.icon && link.icon}
                                        {link.name}
                                    ...
                                    <Link
                                        href={link.href}
                                        className="text-xs uppercase tracking-[0.1em] font-medium text-emerald-royal hover:text-heritage-gold transition-all whitespace-nowrap py-2"
                                    >
                                        {link.name}
                                    </Link>
                                )}
                                <div className={cn(
                                    "absolute bottom-0 left-0 h-px bg-heritage-gold transition-all duration-500",
                                ...
                                <AnimatePresence>
                                    {link.hasDropdown && activeDropdown === link.name && (
                                        <motion.div
                                            ...
                                            exit={{ opacity: 0, y: 10 }}
                                            className="absolute top-full left-0 mt-4 w-[550px] max-w-[calc(100vw_-_80px)] bg-white shadow-2xl border-t-2 border-heritage-gold p-8 grid grid-cols-1 md:grid-cols-2 gap-10"
                                        >
                                            <div className="min-w-0">
                                                <h4 className="text-xs uppercase tracking-widest font-bold text-heritage-gold mb-6 border-b border-heritage-gold/10 pb-2">{t("nav_royal_collections")}</h4>
                                            ...
                                            <div className="bg-emerald-royal/5 p-8 flex flex-col justify-between rounded-xl">
                                                <div>
                                                    <p className="font-serif text-xl text-emerald-royal mb-2 italic">{t("nav_royal_selection_title")}</p>
                                                    <p className="text-xs text-emerald-royal/50 leading-relaxed font-light">{t("nav_royal_selection_desc")}</p>
                                                </div>
                                                <Link
                                                    href="/shop"
                                                    onClick={() => setActiveDropdown(null)}
                                                    className="text-xs uppercase tracking-[0.2em] font-bold text-white bg-emerald-royal px-6 py-3 text-center hover:bg-heritage-gold transition-all gold-gradient-bg"
                                                >
                    ...
                    {/* Center: Logo */}
                    <div className="flex justify-center flex-shrink-0 z-10">
                        <Link href="/" className="relative h-[45px] w-[140px] md:h-[50px] md:w-[150px] lg:h-[60px] lg:w-[180px] transition-all duration-500 hover:scale-105">
                            <RoyalImage
                                src="/img/logo.png"
                                alt="Lily Crown"
                                fill
                    ...
                    {/* Right: Icons & Links */}
                    <div className="flex items-center justify-end gap-2 md:gap-3 lg:gap-4 flex-1">
                        {/* Language toggle - desktop */}
                        <LangToggle className="hidden xl:flex" />
                        <div className="hidden lg:flex items-center gap-4 xl:gap-8 ml-2 xl:ml-4">
                            {navLinks.slice(4).map((link) => (
                                <Link
                                    key={link.name}
                                    href={link.href}
                                    className="text-[10px] xl:text-xs uppercase tracking-[0.15em] xl:tracking-[0.2em] font-medium text-emerald-royal hover:text-heritage-gold transition-all relative group whitespace-nowrap"
                                >
                                    {link.name}
                                                    ...
                                                    {isSearching ? (
                                                        ...
                                                        <div className="py-2">
                                                            <div className="px-4 py-2 border-b border-heritage-gold/5 mb-2">
                                                                <p className="text-[10px] uppercase tracking-widest font-bold text-heritage-gold">{t("nav_found_treasures")} ({searchResults.length})</p>
                                                            </div>
                                                        ...
                                                        <div className="p-8 text-center">
                                                            <p className="text-xs text-emerald-royal/50 italic font-serif">{t("nav_no_treasures")}</p>
                                                        </div>
                                                    )}
                                                </div>
                                                {searchResults.length > 0 && (
                        ...
                        <div className="hidden lg:flex items-center gap-3 xl:gap-4 ml-1 xl:ml-2 border-l border-emerald-royal/10 pl-4 xl:pl-6">
                            {user ? (
                                <div className="relative group">
                                    <button className="flex items-center gap-1.5 xl:gap-2 text-emerald-royal hover:text-heritage-gold transition-all py-2">
                                        <div className="p-1 xl:p-1.5 border border-emerald-royal/20 rounded-full">
                                            <User size={14} className="xl:hidden" />
                                            <User size={16} className="hidden xl:block" />
                                        </div>
                                        <span className="text-[10px] xl:text-xs font-bold uppercase tracking-widest hidden xl:block max-w-[80px] xxl:max-w-[120px] truncate">
                                            {user.name}
                                        </span>
                                        <ChevronDown size={10} className="text-emerald-royal/50 group-hover:rotate-180 transition-transform duration-300" />
                                    </button>
                                    ...
                                    <div className="absolute top-full right-0 mt-2 w-56 bg-white border border-heritage-gold/20 shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform origin-top-right z-50 rounded-sm">
                                        <div className="p-4 border-b border-heritage-gold/10 bg-muslin-cream/20">
                                            <p className="text-[10px] text-emerald-royal/50 uppercase tracking-widest font-bold mb-1">{t("nav_signed_in_as")}</p>
                                ...
                                <div className="flex items-center gap-2 xl:gap-3">
                                    <Link href="/login" className="text-[9px] xl:text-[10px] uppercase tracking-[0.15em] xl:tracking-[0.2em] font-bold text-emerald-royal hover:text-heritage-gold transition-all">
                                        {t("nav_sign_in")}
                                    </Link>
                                    <span className="text-xs text-emerald-royal/20">|</span>
                                    <Link href="/register" className="text-[9px] xl:text-[10px] uppercase tracking-[0.15em] xl:tracking-[0.2em] font-bold text-emerald-royal hover:text-heritage-gold transition-all">
                                        {t("nav_join_us")}
                                    </Link>
                                </div>
                            )}
                        ...
                        <Link
                            href="/cart"
                            className="flex items-center gap-1.5 xl:space-x-2 group bg-emerald-royal text-white px-2.5 py-1.5 sm:px-3 sm:py-2 md:px-5 md:py-2.5 rounded-none hover:bg-heritage-gold transition-all duration-500 shadow-md gold-gradient-bg active:scale-95"
                            aria-label={`View Shopping Bag (${cartCount} items)`}
                        >
                            <ShoppingBag size={16} className="xl:w-[18px] xl:h-[18px]" />
                            <span className="text-[9px] xl:text-[10px] uppercase tracking-[0.1em] font-bold hidden sm:inline">{t("nav_bag")}</span>
                            <span className="bg-white text-emerald-royal text-[8px] xl:text-[9px] font-bold px-1 xl:px-1.5 py-0.5 rounded-full min-w-[14px] xl:min-w-[16px] text-center">
                                {cartCount}
                            </span>
                        </Link>
                    </div>
                ...
                {isMobileMenuOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            style={{ height: "100vh" }}
                            className="fixed top-0 left-0 bottom-0 w-[calc(100%-20px)] min-[480px]:max-w-sm bg-white z-[120] shadow-2xl p-4 sm:p-6 overflow-y-auto"
                        >
                            ...
                            <div className="mb-10">
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        value={searchQuery}
                                        onChange={(e) => setSearchQuery(e.target.value)}
                                        className="w-full pl-10 pr-3 py-2 border border-emerald-royal/10 rounded-lg text-sm text-emerald-royal placeholder:text-emerald-royal/30 focus:outline-none focus:border-heritage-gold transition-colors bg-white"
                                    />
                                </div>
                                            ...
                                            <div className="max-h-[300px] overflow-y-auto">
                                                {isSearching ? (
                                                    ...
                                                    <div className="p-6 text-center">
                                                        <p className="text-[10px] text-emerald-royal/40 italic">{t("nav_no_treasures")}</p>
                                                    </div>
                                                )}
                                            </div>
                                        </motion.div>
                            ...
                            <nav className="space-y-2">
                                    ...
                                    {user ? (
                                        <>
                                            <div className="col-span-2 text-center mb-4">
                                                <p className="text-sm font-serif text-emerald-royal">{t("nav_welcome")}, {user.name}</p>
                                ...
                                <div className="mt-12 text-center">
                                    ...
                                    <p className="text-[10px] uppercase tracking-[0.3em] text-emerald-royal/40 mb-2">{t("nav_connect")}</p>
                                ...
                                {mobileCategoriesOpen && (
                                    ...
                                    >
                                        <div className="flex items-center gap-4 mb-10 pb-4 border-b border-emerald-royal/5">
                                            ...
                                            <h2 className="text-2xl font-serif text-emerald-royal">{t("nav_our_collections")}</h2>
                                        </div>
                                                ...
                                                >
                                                    <div className="absolute inset-0 flex items-center justify-between p-6 z-10">
                                                        <div className="space-y-1">
                                                            ...
                                                            <p className="text-[10px] uppercase tracking-widest text-emerald-royal/50">{t("nav_explore_heritage")}</p>
                                                        </div>
                                        ...
                                        <div className="mt-auto p-6 bg-emerald-royal/5 rounded-2xl">
                                            <p className="text-xs text-emerald-royal/60 italic text-center">{t("nav_nawabi_quote")}</p>
                                        </div>
                                    </motion.div>
                                )}
                            </AnimatePresence>
